...
const FIELD_META: Record<string, FieldMeta> = {
  ...
  internal_dc_input_power: { label: 'DC1 Power', unit: 'W', category: 'Input', numeric: true },
  internal_dc_input_voltage: { label: 'DC1 Voltage', unit: 'V', category: 'Input', numeric: true },
  internal_dc_input_current: { label: 'DC1 Current', unit: 'A', category: 'Input', numeric: true },
