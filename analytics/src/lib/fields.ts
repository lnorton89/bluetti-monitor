...
const FIELD_META: Record<string, FieldMeta> = {
  ...
  internal_dc_input_power: { label: 'DC Bus Power', unit: 'W', category: 'Input', numeric: true },
  internal_dc_input_voltage: { label: 'DC Bus Voltage', unit: 'V', category: 'Input', numeric: true },
  internal_dc_input_current: { label: 'DC Bus Current', unit: 'A', category: 'Input', numeric: true },
