...
export const mockState: AllState = {
  AC5002237000003358: {
    ...
    dc_input_1_power: { value: '402', ts: isoOffset(0) },
    dc_input_2_power: { value: '340', ts: isoOffset(0) },
    dc_input_1_voltage: { value: '63.8', ts: isoOffset(0) },
    dc_input_2_voltage: { value: '61.1', ts: isoOffset(0) },
    internal_ac_voltage: { value: '120.3', ts: isoOffset(0) },
    internal_ac_frequency: { value: '60', ts: isoOffset(0) },
    internal_current_one: { value: '4.1', ts: isoOffset(0) },
    internal_power_one: { value: '486', ts: isoOffset(0) },
    internal_current_two: { value: '4.1', ts: isoOffset(0) },
    internal_power_two: { value: '492', ts: isoOffset(0) },
    internal_current_three: { value: '0', ts: isoOffset(0) },
    internal_power_three: { value: '0', ts: isoOffset(0) },
