...
import { StatHelpTooltip, type StatHelpContent } from './StatHelpTooltip';
 ...
 */
export function MetricTile({ label, value, unit, accent, detail, icon: Icon, className = '', tooltip }: MetricTileProps) {
  return (
