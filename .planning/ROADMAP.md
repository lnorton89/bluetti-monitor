...
Plans:
- [ ] 01-01: Audit and remove legacy host-poller references from docs, scripts, and setup guidance
...
Plans:
- [ ] 02-01: Remove remaining legacy Python poller dependencies and dead integration code
...
|-------|----------------|--------|-----------|
| 1. Complete Bridge Migration | 0/3 | Not started | - |
